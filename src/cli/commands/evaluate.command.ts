...
import { loadEvalConfig } from '../../dataset/loader.js';
import type { EvalSuiteConfig } from '../../types/domain.js';
...
function generateMarkdownReport(results: import('../../types/domain.js').EvalResults): string {
